    ...
    $form.on("submit", function() {
        ...
        $.ajax({
            ...
            data: {
                ...
                caption: emoji[0].emojioneArea.getText(),
                ...
                filter_comment_min: $form.find(":input[name='filter_comment_min']").val(),
                filter_comment_max: $form.find(":input[name='filter_comment_max']").val(),
                filter_like_min: $form.find(":input[name='filter_like_min']").val(),
                filter_like_max: $form.find(":input[name='filter_like_max']").val(),
            },
            error: function() {
...
AutoRepost.CommentsForm = function()
{
