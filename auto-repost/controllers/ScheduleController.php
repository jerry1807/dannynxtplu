...
class ScheduleController extends \Controller
{
    ...
    private function save()
    {
        ...
        $filter_comment_min = (Int)\Input::post("filter_comment_min");
        $filter_comment_max = (Int)\Input::post("filter_comment_max");
        $filter_like_min = (Int)\Input::post("filter_like_min");
        $filter_like_max = (Int)\Input::post("filter_like_max");
        $Schedule
            ->set("data.filter_picture", $filter_picture)
            ->set("data.filter_comment_min", $filter_comment_min)
            ->set("data.filter_comment_max", $filter_comment_max)
            ->set("data.filter_like_min", $filter_like_min)
            ->set("data.filter_like_max", $filter_like_max)
            ->save();
        //Filters End
