...
<html lang="<?= ACTIVE_LANG ?>">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?= PLUGINS_URL."/".$idname."/assets/css/core.css?v=43".VERSION ?>">

        <title><?= __("Auto Repost Plus Module Settings") ?></title>
    </head>
    ...
    <body>
        ...
        <?php 
            $TopBar = new stdClass;
            $TopBar->title = __("Auto Repost Plus Module Settings");
            $TopBar->btn = false;
        ...
        <script type="text/javascript" src="<?= PLUGINS_URL."/".$idname."/assets/js/core.js?v=45".VERSION ?>"></script>
