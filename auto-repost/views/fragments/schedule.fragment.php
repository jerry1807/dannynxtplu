        ...
        <section class="skeleton-content">
            <form class="js-auto-repost-schedule-form"
                ...
                <div class="arp-tab-heads clearfix">
                    ...
                    <a href="<?= APPURL."/e/".$idname."/".$Account->get("id")."/comments" ?>"><?= __("First Comments") ?></a>
                ...
                <div class="section-content">
                    ...
                    <div class="clearfix">
                        <div class="col s12 m10 l8">
                            ...
                            <div class="clearfix mb-20">
                                ...
                                <div class="col s6 s-last m6 m-last l6 l-last">
                                    ...
                                    <select class="input" name="filter_picture">
                                        <option value="0" <?=$Schedule->get("data.filter_picture") == 0 ? "selected" : ""?>><?=__("Deactive")?></option>
                                        <option value="1" <?=$Schedule->get("data.filter_picture") == 1 ? "selected" : ""?>><?=__("Active")?></option>
                                    </select>
                                </div>
                            ...
                            <div class="clearfix mb-20">
                                <div class="col s6 m6 l6">
                                    <label class="form-label"><?=__("Comments Min Amount")?></label>
                                    <input class="input rightpad" name="filter_comment_min" type="number" value="<?=$Schedule->get("data.filter_comment_min")?>">
                                </div>

                                <div class="col s6 s-last m6 m-last l6 l-last">
                                    <label class="form-label"><?=__("Comments Max Amount")?></label>
                                    <input class="input rightpad" name="filter_comment_max" type="number" value="<?=$Schedule->get("data.filter_comment_max")?>">
                                </div>
                            </div>
                            <div class="clearfix mb-20">
                                <div class="col s6 m6 l6">
                                    <label class="form-label"><?=__("Likes Min Amount")?></label>
                                    <input class="input rightpad" name="filter_like_min" type="number" value="<?=$Schedule->get("data.filter_like_min")?>">
                                </div>

                                <div class="col s6 s-last m6 m-last l6 l-last">
                                    <label class="form-label"><?=__("Likes Max Amount")?></label>
                                    <input class="input rightpad" name="filter_like_max" type="number" value="<?=$Schedule->get("data.filter_like_max")?>">
                                </div>
                            </div>
                            <div class="clearfix">
                                <div class="col s12 m6 m-last l6 l-last mb-20">
