    ...
    <div class="clearfix">
        ...
        <section class="skeleton-content">
            ...
            <div class="af-tab-heads clearfix">
                <a href="<?= APPURL."/e/".$idname."/".$Account->get("id") ?>"><?= __("Targeting") ?></a>
                <a href="<?= APPURL."/e/".$idname."/".$Account->get("id")."/log" ?>" class="active"><?= __("Log") ?></a>
            </div>
                            ...
                            <div class="clearfix">
                                ...
                                <div class="inner clearfix">
                                    ...
                                    <?php if ($l->get("data.powerlike") == true && $l->get("data.powerlike.count") != "0"): ?>
                                      ...
                                      <div class="pull-right" style="font-size:40px;text-align:center;height: 60px;width: 60px;margin-left:5px;">
                                        <div class="icon mdi mdi-heart" style="color:red;dispay:block;margin-top: 15px;"></div>
                                        <div style="display:block;font-size:10px;margin-top: 5px;"><?= $l->get("data.powerlike.count") ?> <?= (intval($l->get("data.powerlike.count")) > 1) ? "likes" : "like" ?></div>
                                      </div>

                                      <?php foreach ($l->get("data.powerlike.posts") as $post):?>
                                        <span class="pull-right" style="height: 60px;margin-left:5px;">
                                              <img class="img" style="width:60px;height:60px;border-radius:50%;" src="<?= $post->media_thumb ?>">
                                        </span>
                                      <?php endforeach; ?>
